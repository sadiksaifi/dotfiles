...
[[https://github.com/sadikeey/dotfiles/blob/main/.screenshots/home.png?raw=true]]
...
We killed trayer processes earlier in the autostart, so now we sleep for 2 seconds and then restart conky and trayer.
