...
#+property: header-args :emacs-lisp :tangle hyprland.conf
...
| MODKEY + SHIFT          | actual fullscreen window                       |
| MODKEY + SPACE + SPACE  | full screen window kind like in monocle layout |
...
bind = ,t,submap,reset
bind = SHIFT,t,exec,bemenu-tailwindsearch
